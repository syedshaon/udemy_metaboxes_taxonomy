	 ...
	 $args = array(
			...
			while($query->have_posts()){
				...
				echo '<div class="small-6 medium-3 columns">';
					...
					echo '<a href="' .get_the_permalink($postID). '">';
					echo	get_the_post_thumbnail( $postID, 'filter-recipes');	
...
function gourmet_artistry_setup() {
	...
	add_image_size( 'package-size-1', 550, 1100,  true );
	add_image_size( 'package-size-2', 550, 550,  true );
	add_image_size( 'package-size-3', 550, 275,  true );
	add_image_size( 'package-size-4', 550, 137,  true );
...
function gourmet_artistry_scripts() {
  ...
  wp_enqueue_script('jquery');
	...
	wp_enqueue_script('filterizr', get_template_directory_uri() . '/js/jquery.filterizr.min.js', array('jquery'), '1', true );
  wp_enqueue_script('what-input', get_template_directory_uri() . '/js/what-input.min.js', array(), '20151215', true );
   wp_enqueue_script('packer', get_template_directory_uri() . '/js/packer.js', array(), '1', true );
